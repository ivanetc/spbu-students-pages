...
[Главная](/)/Docker. Переменные окружения.

# Docker. Переменные окружения.

### Содержание
1. [Переменные окружения](#p1)
2. [Основные компоненты Docker](#p2)
3. [Как устроен образ Docker](#p3)
4. [Как развернуть образ](#p4)
5. [Dockerfile](#p5)
6. [Docker-compose](#p6)
## Переменные окружения <a name="p1"></a>
...
## Основные компоненты Docker <a name="p2"></a>
...
## Как устроен образ Docker <a name="p3"></a>
...
## Как развернуть образ <a name="p4"></a>

```sh
docker run image_name: tag_name
```

## Dockerfile <a name="p5"></a>
...
Файл docker-compose.yml является конфигурационным файлом для Docker Compose, который позволяет описать структуру вашего
