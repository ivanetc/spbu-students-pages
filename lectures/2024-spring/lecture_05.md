...
[Главная](/)/Проектирование backend-приложений: архитектура, рефакторинг и шаблоны проектирования

## Проектирование backend-приложений: архитектура, рефакторинг и шаблоны проектирования

### Содержание
1. [Что такое хорошая архитектура](#p1)
2. [Принципы проектирования](#p2)
3. [Слои backend-приложения](#p3)
4. [Code Smells](#p4)
5. [Рефакторинг](#p5)
6. [Шаблоны проектирования (Design Patterns)](#p6)

![](../../resources/lectures/2025-spring/lec05/p15.png)

## 0. Что такое хорошая архитектура <a name="p1"></a>
...
## 1. Принципы проектирования <a name="p2"></a>
...
## 2. Слои backend-приложения <a name="p3"></a>
...
## 5. Шаблоны проектирования (Design Patterns) <a name="p6"></a>
