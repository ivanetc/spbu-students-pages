...
Оценка на экзамене формируется по формуле:

$MARK = 0.4 * HW + 0.3 * TESTS + 0.3 * EXAM$

- HW - средний балл по домашкам
- TESTS - средний балл по опросникам
- EXAM - средний балл по задаче на экзамене

#### Соотношение балла и оценки
- Отлично - 0.87 и выше
- Хорошо - 0.7 и выше
- Удовлетворительно - 0,58 и выше
...
![External Image](../../resources/lectures/2023-fall/lecture_01/ssh.png)
